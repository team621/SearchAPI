...
public class WNCollection {
    ...
    //운영
    public String[] COLLECTIONS = new String[]{"oneplus", "category_oneplus", "thefresh", "category_thefresh", "woodel_gs", "category_woodel_gs" , "woodel_mart" , "category_woodel_mart" , "gs25_reservation" , "category_gs25_reservation" , "wine25_gs" , "category_wine25_gs" };
    public String[] COLLECTIONS_NAME = new String[]{"oneplus", "thefresh", "woodel_gs" , "woodel_mart" , "gs25_reservation"};
    ...
    public String[][] COLLECTION_INFO = new String[][]{
            ...
            ,
            {
                    "category_oneplus", // set index name
                    "oneplus", // set collection name
                    "0,3",  // set pageinfo (start,count)
                    "1,1,1,1,0", // set query analyzer (useKMA,isCase,useOriginal,useSynonym, duplcated detection)
                    "RANK/DESC",  // set sort field (field,order) multi sort '/'
            ...
            ,
            {
                    "category_thefresh", // set index name
                    "thefresh", // set collection name
                    "0,3",  // set pageinfo (start,count)
                    "1,1,1,1,0", // set query analyzer (useKMA,isCase,useOriginal,useSynonym, duplcated detection)
                    "RANK/DESC",  // set sort field (field,order) multi sort '/'
            ...
            ,
            {
                    "category_woodel_gs", // set index name
                    "woodel_gs", // set collection name
                    "0,3",  // set pageinfo (start,count)
                    "1,1,1,1,0", // set query analyzer (useKMA,isCase,useOriginal,useSynonym, duplcated detection)
                    "RANK/DESC",  // set sort field (field,order) multi sort '/'
            ...
            ,
            {
                    "category_woodel_mart", // set index name
                    "woodel_mart", // set collection name
                    "0,3", // set pageinfo (start,count)
                    "1,1,1,1,0", // set query analyzer (useKMA,isCase,useOriginal,useSynonym, duplcated detection)
                    "RANK/DESC,DATE/DESC", // set sort field (field,order) multi sort '/'
            ...
            ,
            {
                    "category_gs25_reservation", // set index name
                    "gs25_reservation", // set collection name
                    "0,3", // set pageinfo (start,count)
                    "1,1,1,1,0", // set query analyzer (useKMA,isCase,useOriginal,useSynonym, duplcated detection)
                    "RANK/DESC,DATE/DESC", // set sort field (field,order) multi sort '/'
            ...
            {
                    "wine25_gs", // set index name
                    "category_wine25_gs", // set collection name
                    "0,3", // set pageinfo (start,count)
                    "1,1,1,1,0", // set query analyzer (useKMA,isCase,useOriginal,useSynonym, duplcated detection)
                    "RANK/DESC,DATE/DESC", // set sort field (field,order) multi sort '/'
                    "basic,rpfmo,100", // set sort field (field,order) multi sort '/'
