...
//    }
    ...
    public int addCollection(String collectionName, int useKma, int isCase) {
        ...
        //System.out.println("[w3AddCollection] "+collectionName);
        return ret;
    }
    ...
    public String[] receiveRecentQueryListResult(int mode, int count) {
        ...
        if( ret < 0 ){
            System.out.println("[W3ReceiveRecentQueryListResult] " + search.w3GetErrorInfo() + ", ret=" + ret);
            return null;
        }
    ...
    public int receiveRecentQueryListResultAsXml(int mode, int count) {
        ...
        if( ret < 0 ){
            System.out.println("[w3ReceiveRecentQueryListResultAsXml] " + search.w3GetErrorInfo() + ", ret=" + ret);
            return -1;
        }
        return ret;
    }
    ...
    public int receiveRecentQueryListResultAsJson(int mode, int count) {
        ...
        if( ret < 0 ){
            System.out.println("[w3ReceiveRecentQueryListResultAsJson] " + search.w3GetErrorInfo() + ", ret=" + ret);
            return -1;
        }
        return ret;
    }
